...
> **Immediate next action toward the objective:** the binding constraint is the **S7 canonical run**; en route, clear the security MUSTs (S2-05 sign+verify gate_v1.json, S6-03 encrypt token store at rest, S5-04 sandbox attack harness) and complete G2 (S4-01) + G4 (S4-03), recomputing the SDO verdict at each landing.
