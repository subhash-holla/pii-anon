...
| Requirements | 22 | 59 |
| Design | 17 | 76 |
| Development | 95 (S1–S3-03: 40 [3 explore + 1 plan + 6 executors + 11 sprint-gate wf + S3-02 7 + S3-03 6]; S3-04 5 + S4-CS-01 12 [iter-1+2, 6-reviewer]; **security-MUSTs session 38**: 3 explore + 2 explore[S4-01/03 pre-map] + 3 iter-1 executors + 15 story reviewers + 2 iter-2 executors + adversarial-close wf 8 + re-close wf 5) | 171 |
| Testing | 0 | 171 |
| **Total** | **171** | **171** |
